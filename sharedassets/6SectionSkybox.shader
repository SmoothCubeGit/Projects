Shader "Custom/SimpleSixBandSkybox_SinglePass"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // 1. Required for Single Pass Instancing
            ...
            struct v2f
            {
                ...
                // 3. Add Instance ID to output for fragment stage
                UNITY_VERTEX_INPUT_INSTANCE_ID
            ...
            {
                v2f o;
                // 4. Initialize Instance ID and Stereo Output
            ...
            {
                // 5. Setup Stereo eye index for fragment
                UNITY_SETUP_STEREO_EYE_INDEX_POST_VERTEX(i);

                float y = normalize(i.dir).y;
                y = y * 0.5 + 0.5; // Map from -1..1 to 0..1
